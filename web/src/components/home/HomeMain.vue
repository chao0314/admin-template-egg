<template>
  <div class="main">
    ...
    <el-card class="main__card">
      ...
      <el-table :data="tableData" stripe border style="width: 100%" height="300">
        <el-table-column type="index" width="48"/>
        <el-table-column prop="username" :label="locale.username" width="100"/>
        <el-table-column prop="email" :label="locale.email" width="240"/>
    ...
    <el-dialog width="40%" top="5vh" v-model="dialogVisibleRef" title="添加">
      <el-form
          :model="form"
          label-position="top"
      >
        <el-form-item :label="locale.username">
          <el-input :prefix-icon="User" v-model="form.username" autocomplete="off"/>
        </el-form-item>
        <el-form-item :label="locale.email">
          <el-input :prefix-icon="Message" v-model="form.email" autocomplete="off"/>
        </el-form-item>
        <el-form-item :label="locale.phone">
          <el-input :prefix-icon="Phone" v-model="form.phone" autocomplete="off"/>
        </el-form-item>
        <el-form-item :label="locale.password">
...
const dialogVisibleRef = ref(true);
const form = reactive({
  username: '',
  email: '',
  phone: '',
